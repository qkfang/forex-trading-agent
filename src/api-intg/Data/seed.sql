...
(1, 0, 1, 'The USD Strength Outlook aligns with this customer''s G10 swing strategy and active EUR/USD exposure. USD bullish sentiment justifies reviewing or trimming long EUR positions.', 'High', 'Sent', '2026-03-29T09:15:00'),
(2, 2, 2, 'EUR/USD Technical Levels article directly supports this customer''s euro-focused portfolio. The identified support at 1.0780 is actionable for their current long EUR position management.', 'High', 'Sent', '2026-03-31T10:45:00'),
(3, 3, 5, 'JPY strength thesis in the BOJ Policy Shift article matches this customer''s USD/JPY short preference and Asian session trading focus. Tactical short entry levels are clearly defined.', 'High', 'Pending', '2026-04-01T07:30:00'),
(1, 1, 6, 'The AUD/NZD Relative Value article fits this customer''s Antipodean pair preference. Current AUD/NZD dislocation represents a carry-efficient opportunity within their risk parameters.', 'Medium', 'Sent', '2026-04-03T11:00:00'),
(4, 4, 8, 'Scandinavian FX analysis on NOK/SEK divergence suits this customer''s Nordic currency mandate at Nordic FX Partners. Mean-reversion setup with clear risk levels aligns with their swing style.', 'High', 'Pending', '2026-04-04T08:00:00'),
(5, 7, 7, 'EM Weekly Review highlights BRL and MXN outperformance directly relevant to this LatAm FX Advisors client. Commodity price tailwinds support existing long MXN position rationale.', 'High', 'Sent', '2026-04-05T08:00:00'),
(3, 3, 3, 'BOJ Policy Shift article reinforces long JPY conviction for this Asia Macro Fund client. BOJ ending NIRP is the catalyst they flagged as a trade trigger in their preference profile.', 'High', 'Sent', '2026-04-02T07:00:00'),
(1, 5, 9, 'CHF Safe Haven Flows article is relevant for this Gulf Finance Group client holding defensive positions. SNB intervention signals provide timing cues for EUR/CHF tactical trades.', 'Medium', 'Pending', '2026-04-04T10:00:00'),
(2, 1, 4, 'Central Bank Watch April 2026 is actionable for this institutional day trader. ECB decision probability analysis provides pre-event positioning guidance for their EUR/USD strategy.', 'High', 'Sent', '2026-04-02T08:00:00'),
(6, 4, 6, 'The NOK/SEK Divergence article directly matches this Nordic FX Partners client''s Scandinavian currency mandate. Our desk recommends they review the long NOK/SEK setup with 0.9850 target.', 'High', 'Pending', '2026-04-05T07:45:00'),
(5, 8, 7, 'EM Weekly Review outlines MXN and BRL outperformance consistent with this client''s commodity-linked EM long bias at Oceania Partners. Supports holding current positions into the week ahead.', 'Medium', 'Sent', '2026-04-06T08:30:00'),
(1, 2, 1, 'USD Strength Outlook Q2 highlights DXY range 104-107, directly impacting this client''s EUR/USD short hedge at Euro Capital Ltd. Bearish EUR view aligns with their treasury hedging mandate.', 'High', 'Sent', '2026-03-30T09:00:00'),
(3, 9, 5, 'BOJ Policy Shift with USD/JPY downside targets is highly relevant for this client''s frontier market diversification strategy at Frontier Markets Inc. JPY longs complement their current safe-haven allocation.', 'Medium', 'Pending', '2026-04-06T11:00:00');
...
-------------------------------------------------------
-- ResearchPatterns (50 records - Enhanced Forex & Commodity Patterns)
-------------------------------------------------------
...
-- AUD/USD Focused Patterns (15 records)
('AUD/USD', 'China PMI Deterioration', 'Daily', 'Sell', 84.50, 'Chinese manufacturing PMI fell below 50, signaling contraction. Historical correlation shows AUD weakness follows within 3-5 days. Iron ore demand concerns mounting.', 'Kenji Tanaka', '2026-04-01T02:00:00', '2026-04-30T23:59:00', 'Active'),
('AUD/USD', 'Iron Ore Price Collapse', 'Daily', 'Sell', 89.20, 'Iron ore prices dropped 8% to $98/tonne on Chinese demand concerns. AUD historically follows with 2-3 day lag. Target: 0.6720.', 'Liam O''Brien', '2026-03-28T05:30:00', '2026-04-20T23:59:00', 'Active'),
('AUD/USD', 'RBA Dovish Pivot', 'Weekly', 'Sell', 82.30, 'RBA minutes revealed inflation concerns easing faster than expected. Markets pricing 75% chance of May rate cut. AUD vulnerable to 0.6650.', 'Emily Carter', '2026-04-01T04:30:00', '2026-05-15T23:59:00', 'Active'),
('AUD/USD', 'Fed-RBA Rate Differential Widening', 'Monthly', 'Sell', 87.40, 'US-Australia 2-year rate spread widened to 180bps, highest since 2019. Carry trade unwinding pressures AUD. Multi-week downtrend expected.', 'Sarah Mitchell', '2026-03-25T09:00:00', '2026-06-30T23:59:00', 'Active'),
('AUD/USD', 'China Stimulus Package', 'Daily', 'Buy', 91.30, 'Beijing announced CNY 2 trillion infrastructure stimulus. Historical analysis shows AUD rallies 2-4% within two weeks on China fiscal expansion.', 'Kenji Tanaka', '2026-03-09T02:00:00', '2026-04-15T23:59:00', 'Expired'),
('AUD/USD', 'Safe-Haven Flight', 'H4', 'Sell', 78.60, 'Middle East tensions escalating. Risk-off flows typically pressure AUD as commodity currency. Gold rising, AUD falling - classic risk aversion pattern.', 'Sarah Mitchell', '2026-04-02T14:00:00', '2026-04-18T23:59:00', 'Active'),
('AUD/USD', 'Copper Price Breakout', 'Daily', 'Buy', 80.50, 'Copper prices broke above $4.20/lb on supply concerns. AUD/USD correlation to copper at 0.78. Bullish continuation to 0.6980 likely.', 'Liam O''Brien', '2026-03-15T10:00:00', '2026-04-25T23:59:00', 'Active'),
('AUD/USD', 'Australian Employment Surge', 'Daily', 'Buy', 76.80, 'Australia added 68K jobs vs 25K forecast. Unemployment dropped to 3.6%. RBA rate cut expectations pushed back. AUD strength to 0.7050.', 'Emily Carter', '2026-03-20T01:30:00', '2026-04-10T23:59:00', 'Expired'),
('AUD/USD', 'China-Australia Trade Tensions', 'Weekly', 'Sell', 73.20, 'Renewed tariff threats on Australian exports. Wine and barley sectors affected. Trade uncertainty typically weighs on AUD 1-2%.', 'Kenji Tanaka', '2026-03-18T06:00:00', '2026-05-01T23:59:00', 'Active'),
('AUD/USD', 'LNG Export Surge', 'Monthly', 'Buy', 69.50, 'Australian LNG exports hit record highs on Asian winter demand. Energy trade surplus boosting AUD fundamentals. Long-term support building.', 'Liam O''Brien', '2026-02-28T08:00:00', '2026-06-30T23:59:00', 'Active'),
('AUD/USD', 'USD Broad Weakness', 'Weekly', 'Buy', 85.70, 'DXY breaking below 103.50 support. Fed dovish pivot accelerating. AUD benefits as high-beta currency in USD weakness environment.', 'Sarah Mitchell', '2026-03-30T09:00:00', '2026-04-30T23:59:00', 'Active'),
('AUD/USD', 'Terms of Trade Improvement', 'Monthly', 'Buy', 72.40, 'Australian ToT index rose 3.2% as commodity export prices outpace import costs. Structural AUD support through Q2 2026.', 'Emily Carter', '2026-03-12T06:00:00', '2026-06-30T23:59:00', 'Active'),
('AUD/USD', 'Property Market Stabilization', 'Weekly', 'Buy', 68.90, 'Sydney and Melbourne house prices up 2.8% QoQ. RBA less likely to cut aggressively. Domestic demand resilience supports AUD.', 'Emily Carter', '2026-03-28T02:00:00', '2026-05-01T23:59:00', 'Active'),
('AUD/USD', 'Equity Market Risk-On', 'Daily', 'Buy', 81.60, 'S&P 500 and ASX 200 rallying in tandem. Risk appetite favors commodity currencies. AUD/USD correlation to equities at 0.82.', 'Sarah Mitchell', '2026-04-03T14:00:00', '2026-04-20T23:59:00', 'Active'),
('AUD/USD', 'Gold Price Inverse Correlation', 'Daily', 'Sell', 74.30, 'Gold surged to $4,720/oz on geopolitical fears. AUD underperforms despite mining sector ties. Safe-haven demand trumping commodity linkage.', 'Liam O''Brien', '2026-04-04T08:00:00', '2026-04-18T23:59:00', 'Active'),

-- Cross-Currency Commodity Patterns (12 records)
('EUR/USD', 'ECB-Fed Policy Divergence', 'Monthly', 'Sell', 88.90, 'ECB signaling June rate cut while Fed remains on hold. Rate differential widening favors USD. EUR/USD target 1.0400 by Q3.', 'Marco Rossi', '2026-04-03T15:00:00', '2026-07-31T23:59:00', 'Active'),
('USD/JPY', 'BOJ Intervention Threat', 'Daily', 'Sell', 79.80, 'USD/JPY approaching 160.00, historically triggering MOF/BOJ intervention. Verbal warnings increasing. Downside risk to 152.00.', 'Kenji Tanaka', '2026-04-04T03:00:00', '2026-04-25T23:59:00', 'Active'),
('USD/CAD', 'WTI Crude Collapse', 'Daily', 'Buy', 83.40, 'Oil prices plunged 12% to $95/bbl on demand fears. CAD weakening as petrocurrency. USD/CAD rally to 1.4250 underway.', 'Sarah Mitchell', '2026-03-22T15:00:00', '2026-04-30T23:59:00', 'Active'),
('GBP/USD', 'UK Stagflation Risk', 'Weekly', 'Sell', 81.20, 'UK GDP contracted 0.2% while inflation sticky at 3.8%. BoE facing impossible policy choice. Sterling vulnerable to 1.2200.', 'Emily Carter', '2026-04-04T12:00:00', '2026-05-15T23:59:00', 'Active'),
('USD/CHF', 'SNB Intervention Floor', 'Daily', 'Buy', 70.50, 'EUR/CHF approaching SNB comfort zone at 1.0650. SNB verbally warning against excessive franc strength. USD/CHF finding support.', 'Marco Rossi', '2026-04-02T08:30:00', '2026-04-20T23:59:00', 'Active'),
('NZD/USD', 'Dairy Auction Price Surge', 'Weekly', 'Buy', 77.60, 'GDT dairy prices jumped 8.2% at latest auction. NZ export revenues improving. NZD/USD upside to 0.6150 on fundamentals.', 'Liam O''Brien', '2026-04-04T06:00:00', '2026-04-30T23:59:00', 'Active'),
('USD/MXN', 'USMCA Trade Uncertainty', 'Monthly', 'Buy', 75.80, 'USMCA renegotiation talks stalling. MXN vulnerable to trade policy shifts. USD/MXN grinding higher toward 17.80.', 'Hugo Santos', '2026-03-15T16:00:00', '2026-06-30T23:59:00', 'Active'),
('EUR/GBP', 'Brexit Trade Friction', 'Weekly', 'Buy', 68.40, 'UK-EU trade volumes declining on regulatory divergence. Competitiveness concerns weigh on GBP. EUR/GBP bias toward 0.8750.', 'Emily Carter', '2026-03-28T10:00:00', '2026-05-01T23:59:00', 'Active'),
('USD/CNH', 'PBOC Daily Fix Manipulation', 'Daily', 'Sell', 72.90, 'PBOC setting CNH fix stronger than expected for 5 consecutive days. Yuan strength policy limiting USD/CNH upside. Range-bound near 7.20.', 'Kenji Tanaka', '2026-04-01T02:30:00', '2026-04-20T23:59:00', 'Active'),
('EUR/JPY', 'Carry Trade Unwind', 'Weekly', 'Sell', 86.30, 'EUR/JPY carry positions being liquidated as BOJ normalizes policy. Vol spike indicates systematic selling. Target 178.00.', 'Marco Rossi', '2026-03-30T09:00:00', '2026-04-30T23:59:00', 'Active'),
('GBP/AUD', 'Commodity vs Services Divergence', 'Monthly', 'Sell', 71.50, 'Commodity prices outperforming services economy. Australia terms-of-trade improving vs UK. GBP/AUD downtrend to 1.8500.', 'Liam O''Brien', '2026-03-10T11:00:00', '2026-06-30T23:59:00', 'Active'),
('USD/BRL', 'Brazil Political Risk Premium', 'Weekly', 'Buy', 79.20, 'Brazilian fiscal concerns mounting ahead of elections. Political uncertainty driving USD/BRL higher. Target 5.45.', 'Hugo Santos', '2026-03-25T18:00:00', '2026-05-31T23:59:00', 'Active'),

-- Geopolitical & Risk Patterns (12 records)
('AUD/USD', 'Middle East Oil Supply Shock', 'Weekly', 'Sell', 87.60, 'Strait of Hormuz tensions threatening 20% global oil supply. Risk-off environment pressuring commodity currencies despite energy price spike.', 'Sarah Mitchell', '2026-04-02T10:00:00', '2026-05-15T23:59:00', 'Active'),
('EUR/USD', 'Ukraine War Escalation', 'Daily', 'Sell', 82.40, 'Eastern Europe conflict intensifying. EUR vulnerable to energy security concerns. Safe-haven USD bid emerging.', 'Marco Rossi', '2026-03-18T14:00:00', '2026-04-20T23:59:00', 'Active'),
('USD/JPY', 'North Korea Nuclear Test', 'Daily', 'Sell', 76.50, 'Pyongyang conducting weapons test. Regional security concerns boosting JPY safe-haven demand. USD/JPY pullback to 148.50.', 'Kenji Tanaka', '2026-03-12T04:00:00', '2026-04-10T23:59:00', 'Expired'),
('GBP/USD', 'Scotland Independence Vote', 'Monthly', 'Sell', 73.80, 'Scottish referendum scheduled for June 2026. Constitutional uncertainty weighing on GBP. Break below 1.2400 accelerates decline.', 'Emily Carter', '2026-03-20T09:00:00', '2026-07-01T23:59:00', 'Active'),
('USD/TRY', 'Turkish Election Volatility', 'Weekly', 'Buy', 85.90, 'Erdogan government facing credibility crisis. Unorthodox policy risks persist. USD/TRY spike toward 39.50 likely.', 'Hugo Santos', '2026-04-01T10:00:00', '2026-05-01T23:59:00', 'Active'),
('EUR/CHF', 'European Banking Crisis', 'Daily', 'Sell', 88.70, 'Mid-tier European banks showing stress. Credit Suisse memories resurfacing. CHF safe-haven bid pushing EUR/CHF to 1.0600.', 'Marco Rossi', '2026-03-15T08:00:00', '2026-04-15T23:59:00', 'Expired'),
('USD/ZAR', 'South Africa Load Shedding', 'Weekly', 'Buy', 81.30, 'Eskom Grid returning to stage 5-6 blackouts. Economic damage mounting. ZAR weakness to continue, USD/ZAR target 18.95.', 'Hugo Santos', '2026-04-04T10:00:00', '2026-05-15T23:59:00', 'Active'),
('AUD/USD', 'Taiwan Strait Tensions', 'Daily', 'Sell', 84.20, 'China-Taiwan military exercises escalating. Regional instability pressuring risk assets. AUD vulnerable as Asia-proxy currency.', 'Kenji Tanaka', '2026-03-29T04:00:00', '2026-04-20T23:59:00', 'Active'),
('EUR/USD', 'France Political Gridlock', 'Monthly', 'Sell', 69.80, 'French parliament deadlocked on fiscal reforms. Debt sustainability concerns emerging. EUR at risk if spreads widen vs Germany.', 'Marco Rossi', '2026-03-08T15:00:00', '2026-06-30T23:59:00', 'Active'),
('USD/KRW', 'Korean Peninsula Reunification Talks', 'Weekly', 'Sell', 64.50, 'Historic North-South Korea dialogue beginning. Optimism boosting KRW. USD/KRW downside to 1,310 if talks progress.', 'Kenji Tanaka', '2026-02-18T02:30:00', '2026-05-01T23:59:00', 'Active'),
('GBP/USD', 'Northern Ireland Protocol Crisis', 'Weekly', 'Sell', 77.40, 'UK-EU tensions over Irish Sea border checks. Brexit wounds reopening. GBP downside risk to 1.2350 on political uncertainty.', 'Emily Carter', '2026-03-25T11:00:00', '2026-05-01T23:59:00', 'Active'),
('USD/RUB', 'Russia Sanctions Expansion', 'Monthly', 'Buy', 89.50, 'G7 announcing new sanctions targeting Russian energy sector. RUB facing renewed pressure. USD/RUB rally to 95.00 expected.', 'Marco Rossi', '2026-03-05T13:00:00', '2026-06-30T23:59:00', 'Active'),

-- Central Bank & Monetary Policy Patterns (11 records)
('EUR/USD', 'ECB QT Acceleration', 'Monthly', 'Sell', 78.60, 'ECB plans to accelerate balance sheet reduction from €30bn to €50bn monthly. Liquidity drain negative for EUR vs USD.', 'Marco Rossi', '2026-03-12T15:00:00', '2026-07-31T23:59:00', 'Active'),
('GBP/USD', 'BoE Emergency Rate Hike', 'Daily', 'Buy', 82.50, 'BoE surprised with 50bp hike to combat persistent inflation. GBP spiking on hawkish shock. Near-term target 1.2950.', 'Emily Carter', '2026-02-20T12:00:00', '2026-04-01T23:59:00', 'Expired'),
('AUD/USD', 'RBA Unconventional Policy Signals', 'Weekly', 'Sell', 71.20, 'RBA discussing potential return to yield curve control if conditions deteriorate. Market skepticism weighing on AUD credibility.', 'Emily Carter', '2026-03-22T04:30:00', '2026-05-01T23:59:00', 'Active'),
('USD/JPY', 'BOJ Negative Rates Exit', 'Monthly', 'Sell', 88.40, 'BOJ officially ending NIRP and raising policy rate to +0.25%. Historic shift supporting JPY. USD/JPY multi-month decline to 145.00.', 'Kenji Tanaka', '2026-03-19T03:00:00', '2026-07-31T23:59:00', 'Active'),
('EUR/USD', 'Fed Forward Guidance Shift', 'Weekly', 'Buy', 80.70, 'Powell signaling higher-for-longer stance may be ending. Markets repricing Fed cuts to September. EUR/USD relief rally to 1.0950.', 'Sarah Mitchell', '2026-04-04T18:00:00', '2026-05-01T23:59:00', 'Active'),
('USD/CAD', 'BoC-Fed Meeting Collision', 'Daily', 'Sell', 76.30, 'BoC and Fed both meeting same week. Diverging outlooks creating volatility. CAD strength if BoC holds while Fed softens.', 'Sarah Mitchell', '2026-04-01T14:00:00', '2026-04-18T23:59:00', 'Active'),
('GBP/JPY', 'BoE-BOJ Policy Gap Widening', 'Monthly', 'Buy', 84.80, 'UK maintaining higher rates while BOJ proceeding slowly. Rate differential supporting GBP/JPY carry trade. Target 198.00.', 'Marco Rossi', '2026-03-15T12:00:00', '2026-06-30T23:59:00', 'Active'),
('NZD/USD', 'RBNZ Surprise Hawkish Hold', 'Daily', 'Buy', 79.40, 'Reserve Bank of New Zealand holding rates at 5.50% vs expected cut. NZD surging 1.2% on hawkish surprise. Momentum to 0.6250.', 'Liam O''Brien', '2026-02-26T22:00:00', '2026-04-10T23:59:00', 'Expired'),

...
Upload-Documents -IndexName $knowledgeIndexName -DocumentFolder (Join-Path $scriptDir "fx_knowledge")

# --- fx_service_doc index ---
...
Upload-Documents -IndexName $serviceDocIndexName -DocumentFolder (Join-Path $scriptDir "fx_doc")

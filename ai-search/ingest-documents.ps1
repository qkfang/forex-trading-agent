...
Upload-Documents -IndexName "${IndexPrefix}_knowledge" -DocumentFolder (Join-Path $scriptDir "fx_knowledge")

Write-Host "Ingesting documents into '${IndexPrefix}_service_doc'..."
Upload-Documents -IndexName "${IndexPrefix}_service_doc" -DocumentFolder (Join-Path $scriptDir "fx_doc")
